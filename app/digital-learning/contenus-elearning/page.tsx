...
export const metadata: Metadata = {
  ...
  description:
    "Conception de contenus digitaux sur-mesure : vidéos, capsules, MOOC, réalité virtuelle.",
};
...
const portfolio = [
  {
    title: "MOOC Technologie Béton",
    client: "Industriel ciment",
    type: "MOOC",
  },
  { title: "Capsules Sécurité VR", client: "Groupe BTP", type: "VR" },
  {
    title: "E-learning Produits",
    client: "Distributeur matériaux",
    type: "E-learning",
  },
...
const steps = [
  {
    step: "1",
    title: "Cadrage",
    description: "Analyse des objectifs pédagogiques et du public cible",
  },
  {
    step: "2",
    title: "Conception",
    description: "Scénarisation et storyboarding des contenus",
  },
  {
    step: "3",
    title: "Production",
    description:
      "Réalisation des contenus (tournage, animation, développement)",
  },
  {
    step: "4",
    title: "Déploiement",
    description: "Intégration sur votre plateforme et suivi",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        description="Conception et production de contenus pédagogiques digitaux sur-mesure pour vos formations."
            ...
            {steps.map((step, idx) => (
              <div key={idx} className="relative">
                <div className="bg-white rounded-xl p-6">
                  <span className="text-4xl font-bold text-primary/20 mb-2 block">
                    {step.step}
                  </span>
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {portfolio.map((item, idx) => (
              <div
                key={idx}
                className="group bg-secondary rounded-xl overflow-hidden hover:shadow-lg transition-all"
              >
