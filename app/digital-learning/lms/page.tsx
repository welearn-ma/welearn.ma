...
import { Monitor, Users, BarChart3, BookOpen, Shield, Smartphone, ArrowRight, CheckCircle, Play } from "lucide-react"

export const metadata: Metadata = {
  title: "Plateforme LMS | Solutions Digital Learning | Welearn",
  description: "Découvrez welearn.ac, notre plateforme LMS propriétaire pour une expérience d'apprentissage optimale.",
}
...
const features = [
  {
    ...
    description: "Navigation simple et ergonomique pour une prise en main immédiate.",
  },
  {
    icon: BookOpen,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                Notre LMS a été développé en interne pour répondre aux besoins spécifiques des professionnels de la
                Construction. Interface intuitive, contenus riches et suivi personnalisé pour maximiser votre
                apprentissage.
              </p>
      ...
      <section className="py-20 lg:py-28 bg-secondary">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-sans text-3xl md:text-4xl font-bold text-foreground">Tout ce dont vous avez besoin</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-6 hover:shadow-lg transition-shadow">
                ...
                <h3 className="font-sans text-lg font-semibold text-foreground mb-2">{feature.title}</h3>
      ...
      <section className="py-20 lg:py-28 bg-(--color-welearn-navy)">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 mb-8">
            Créez votre compte sur welearn.ac et accédez à nos formations dès aujourd'hui.
          </p>
