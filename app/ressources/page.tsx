...
import { FileText, BookOpen, Video, Briefcase, HelpCircle, ArrowRight } from "lucide-react"

export const metadata: Metadata = {
  title: "Ressources | Welearn",
  description: "Actualités, articles, webinaires et études de cas sur la formation professionnelle dans le BTP.",
}
...
const resourceCategories = [
  ...
  {
    title: "Blog / Articles",
    description: "Analyses, conseils et bonnes pratiques pour les professionnels du BTP et de la formation.",
  ...
  {
    title: "Webinaires",
    description: "Replays de nos webinaires et conférences en ligne sur les thématiques métiers.",
  ...
  {
    title: "Études de cas",
    description: "Découvrez comment nos clients ont transformé leurs équipes grâce à la formation.",
  ...
  {
    title: "FAQ",
    description: "Réponses aux questions fréquentes sur nos formations et services.",
    href: "/ressources/faq",
    icon: HelpCircle,
    count: "30+ questions",
  },
      ...
      <section className="relative py-20 lg:py-28 bg-(--color-welearn-navy)">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto">
            Actualités, articles de fond, webinaires et études de cas pour approfondir vos connaissances.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {resourceCategories.map((category) => (
              ...
              >
                ...
                <h2 className="font-sans text-xl font-bold text-foreground mb-3">{category.title}</h2>
