...
export const metadata: Metadata = {
  ...
  description: "Catalogue complet de formations techniques BIM et construction pour les entreprises.",
}
...
const categories = [
  {
    ...
    formations: [
      ...
      { title: "Revit Architecture", duration: "5 jours", level: "Intermédiaire" },
  ...
  },
  {
    ...
    formations: [
      { title: "Fondamentaux du management de projet", duration: "3 jours", level: "Débutant" },
      { title: "Préparation PMP®", duration: "5 jours", level: "Avancé" },
      { title: "MS Project", duration: "2 jours", level: "Intermédiaire" },
      { title: "Méthodes agiles dans la construction", duration: "2 jours", level: "Intermédiaire" },
    ],
  },
  {
    ...
    formations: [
      ...
      { title: "Robot Structural Analysis", duration: "4 jours", level: "Avancé" },
  ...
  },
  {
    ...
    formations: [
      { title: "RT 2012 / RE 2020", duration: "2 jours", level: "Intermédiaire" },
      { title: "Simulation thermique dynamique", duration: "3 jours", level: "Avancé" },
      { title: "Audit énergétique bâtiment", duration: "3 jours", level: "Intermédiaire" },
    ],
  },
]
      ...
      <section className="relative py-16 lg:py-24 bg-(--color-welearn-navy)">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-white">Catalogue Formations</span>
          </div>
          <h1 className="font-sans text-4xl md:text-5xl font-bold text-white mb-6">Catalogue des Formations Intra</h1>
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            Plus de 50 formations techniques disponibles pour vos équipes, animées par des experts métier.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-secondary border-b border-border">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-foreground font-medium">Téléchargez notre catalogue complet au format PDF</p>
      ...
      <section className="py-20 lg:py-28 bg-(--color-welearn-navy)">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Nous pouvons concevoir une formation sur mesure adaptée à vos besoins spécifiques.
          </p>
