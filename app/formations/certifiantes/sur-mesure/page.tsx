...
const steps = [
  {
    ...
    description:
      "Échange approfondi pour comprendre vos enjeux, objectifs et contraintes.",
  },
  {
    icon: FileText,
    title: "Conception du programme",
    description:
      "Élaboration d'un programme pédagogique personnalisé avec nos experts.",
  },
  {
    icon: Users,
    title: "Animation de la formation",
    description:
      "Déploiement de la formation par des formateurs experts dans votre domaine.",
  },
  {
    icon: Rocket,
    title: "Suivi et évaluation",
    description:
      "Mesure de l'impact et accompagnement post-formation pour ancrer les acquis.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        description="Des programmes de formation conçus spécifiquement pour répondre aux besoins de votre entreprise et de vos équipes."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Une formation sur mesure garantit un transfert de compétences
                optimal car elle est construite autour de vos problématiques
                réelles et utilise des exemples issus de votre contexte
                professionnel.
              </p>
              <Button
                asChild
      ...
      <section className="py-20 lg:py-28 bg-(--color-welearn-navy)">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Contactez-nous pour discuter de vos besoins et recevoir une
