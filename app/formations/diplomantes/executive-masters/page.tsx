...
import { Clock, Users, Award, CheckCircle, ArrowRight, GraduationCap, Download } from "lucide-react"

export const metadata: Metadata = {
  title: "Executive Masters | Formations Diplômantes | Welearn",
  description: "Programmes Executive Master en BIM, Immobilier et Management de Projet Construction.",
}
...
const masters = [
  {
    ...
    prerequisites: ["Bac+5 ou Bac+4 avec 3 ans d'expérience", "Expérience dans le secteur BTP"],
    highlights: [
  ...
  },
  {
    ...
    prerequisites: ["Bac+4 minimum", "Expérience professionnelle significative"],
    highlights: [
    ...
    <>
      ...
      <section className="relative py-16 lg:py-24 bg-(--color-welearn-navy)">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          ...
          <h1 className="font-sans text-4xl md:text-5xl font-bold text-white mb-6">Executive Masters</h1>
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            Programmes d'excellence pour cadres et dirigeants, en partenariat avec les grandes écoles.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="space-y-12">
            {masters.map((program) => (
              <div key={program.id} id={program.id} className="bg-secondary rounded-2xl p-8 lg:p-10 scroll-mt-24">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2">
                    <h2 className="font-sans text-2xl lg:text-3xl font-bold text-foreground mb-2">{program.title}</h2>
                    <p className="text-primary font-medium mb-4">En partenariat avec {program.partner}</p>
                    <p className="text-muted-foreground leading-relaxed mb-6">{program.description}</p>

                    <div className="mb-6">
                      <h4 className="font-semibold text-foreground mb-3">Objectifs pédagogiques</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-3">Prérequis</h4>
                  ...
                  <div className="bg-white rounded-xl p-6 h-fit">
                    <div className="space-y-4 mb-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium text-foreground">Diplômant</span>
                      </div>
                    </div>
