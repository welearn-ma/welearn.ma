export type PhoneCountry = {
  /** Code ISO 3166-1 alpha-2, utilisé pour l'icône de drapeau (flagcdn.com). */
  code: string;
  name: string;
  dialCode: string;
};

// Pays mis en avant en tête de liste (marché principal de Welearn).
const PRIORITY_CODES = ["MA", "FR", "DZ", "TN"];
...
const ALL_COUNTRIES: PhoneCountry[] = [
  ...
  { code: "DO", name: "République dominicaine", dialCode: "+1809" },
  ...
  { code: "TC", name: "Turques-et-Caïques", dialCode: "+1649" },
...
const priority = PRIORITY_CODES.map(
  (code) => ALL_COUNTRIES.find((country) => country.code === code)!,
);
const rest = ALL_COUNTRIES.filter(
  (country) => !PRIORITY_CODES.includes(country.code),
).sort((a, b) => a.name.localeCompare(b.name, "fr"));

export const PHONE_COUNTRIES: PhoneCountry[] = [...priority, ...rest];
