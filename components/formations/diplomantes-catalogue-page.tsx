...
function getCtaHref(diplomante: Diplomante) {
  if (diplomante.badge === "Executive Masters") {
    return "/formations/diplomantes/executive-masters";
  }
  return "/formations/diplomantes/licences-pro";
}
              ...
              >
                ...
                <div className="flex h-full flex-col p-6">
                  ...
                  <div className="mt-auto pt-5">
                    ...
                    >
                      <Link href={getCtaHref(diplomante)}>
                        En savoir plus
